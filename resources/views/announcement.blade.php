...
@section('content')
    <div class="animated fadeIn">
            ...
            <div class="card-header text-center title-panel bg-dark text-white mb-3" style="font-family: cursive !important; font-size: 2em; background: rgba(0,0,0,0.8) !important">CONVOCATORIAS</div>
