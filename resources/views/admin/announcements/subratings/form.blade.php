    ...
    <div class="col-md-12 mb-3">
        ...
        <div class="input-group">
            ...
            <input
                ...
                name="title"
                placeholder="Ingrese el title" type="text" value="{{ old('title', isset($subrating) ? $subrating->title : '') }}">
        </div>
    ...
    <div class="col-md-12 mb-2">
        ...
        <div class="input-group">
            ...
            <input
                ...
                name="percentage"
                placeholder="Ingrese el porcentaje de 1 a {{ $total }} %" type="text" value="{{ old('percentage', isset($subrating) ? $subrating->percentage*100 : '') }}">
    ...
    <div class="col-md-12 mb-3">
        ...
        <div class="input-group">
            ...
            <textarea
                    ...
                    name="description"
                    cols="30" rows="5"
                    placeholder="Ingrese una descripcion" type="text">{{ old('description', isset($subrating) ? $subrating->description : '') }}</textarea>
        </div>
