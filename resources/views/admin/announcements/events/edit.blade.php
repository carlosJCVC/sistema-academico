            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-edit"></i>Editar Evento</div>
                    <div class="card-body">

                        <form class="form-horizontal" action="{{ route('admin.events.update', [ 'announcement' => $announcement, 'event' => $event ] ) }}" method="POST" autocomplete="off">
                            {{ method_field('PUT')}}
                            {{ csrf_field() }}
