            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-edit"></i>Editar requisito</div>
                    <div class="card-body">

                        <form class="form-horizontal" action="{{ route('admin.conditions.update', [ 'announcement' => $announcement, 'condition' => $condition ] ) }}" method="POST" autocomplete="off">
                            {{ method_field('PUT')}}
                            {{ csrf_field() }}
