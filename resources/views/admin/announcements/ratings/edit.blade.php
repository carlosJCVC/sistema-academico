            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-edit"></i>Editar Calificación de conocimiento</div>
                    <div class="card-body">

                        <form class="form-horizontal" action="{{ route('admin.ratings.update', [ 'announcement' => $announcement, 'rating' => $rating ] ) }}" method="POST" autocomplete="off">
                            {{ method_field('PUT')}}
                            {{ csrf_field() }}
