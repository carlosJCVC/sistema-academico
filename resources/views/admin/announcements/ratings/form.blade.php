    ...
    <div class="col-md-12 mb-3">
        ...
        <div class="input-group">
            ...
            <input
                ...
                name="title"
                placeholder="Ingrese el title" type="text" value="{{ old('title', isset($rating) ? $rating->title : '') }}">
        </div>
    ...
    <div class="col-md-12 mb-2">
        ...
        <div class="input-group">
            ...
            <input
                ...
                name="percentage"
                placeholder="Ingrese el porcentaje de 1 a 100" type="text" value="{{ old('percentage', isset($rating) ? $rating->percentage*100 : '') }}">
    ...
    <div class="col-md-12 mb-3">
        ...
        <div class="input-group">
            ...
            <textarea
                    ...
                    name="description"
                    cols="30" rows="5"
                    placeholder="Ingrese una descripcion" type="text">{{ old('description', isset($rating) ? $rating->description : '') }}</textarea>
        </div>
