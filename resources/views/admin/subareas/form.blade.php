    ...
    <div class="col-md-6 mb-3">
        ...
        <div class="input-group">
            ...
            <input
                ...
                name="name"
                placeholder="Ingrese Nombre" type="text"  value="{{ old('name', isset($subarea) ? $subarea->name : '') }}">
        </div>
    ...
    <div class="col-md-12 mb-3">
        ...
        <div class="input-group">
            ...
            <textarea
                    ...
                    name="description"
                    placeholder="Ingrese una descripcion" type="text">{{ old('description', isset($subarea) ? $subarea->description : '') }}</textarea>
        </div>
