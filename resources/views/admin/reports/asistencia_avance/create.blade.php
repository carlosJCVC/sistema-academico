            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-edit"></i>Crear Informe Asistencia y Avance</div>
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.asistencia-avance.store') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
